...
namespace IE_WinForms
{
    ...
    /// </summary>
    public class tBarBackView : System.Windows.Forms.Form
    {
        ...
        private ToolBarButton MakeBottle;
        private ToolBarButton DrawBaseRect;
        ...
        public tBarBackView()
        {
            ...
            //
            IE_WinForms.tBarBackView.myNbOfChildren = 0;
        }
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(tBarBackView));
            ...
            this.MakeBottle = new System.Windows.Forms.ToolBarButton();
            this.DrawBaseRect = new System.Windows.Forms.ToolBarButton();
            this.SuspendLayout();
            // 
            // mainMenu1
            // 
            ...
            this.toolBarTool.Size = new System.Drawing.Size(763, 28);
            ...
            this.myStatusBar.Location = new System.Drawing.Point(0, 388);
            this.myStatusBar.Name = "myStatusBar";
            this.myStatusBar.Size = new System.Drawing.Size(763, 24);
            ...
            this.toolBarView.Size = new System.Drawing.Size(763, 41);
            ...
            // MakeBottle
            // 
            this.MakeBottle.ImageIndex = 23;
            this.MakeBottle.Name = "MakeBottle";
            // 
            // DrawBaseRect
            // 
            this.DrawBaseRect.Name = "DrawBaseRect";
            this.DrawBaseRect.Text = "drawBasic";
            this.DrawBaseRect.ToolTipText = "画一个基本框型";
            // 
            // tBarBackView
            // 
        ...
        static void Main()
        {
            Application.Run(new tBarBackView());
        }
        ...
        public void OnNewFile()
        {
            ...
            IE_WinForms.tBarBackView.myNbOfChildren = IE_WinForms.tBarBackView.myNbOfChildren + 1;
            newForm.SetIndex(IE_WinForms.tBarBackView.myNbOfChildren, 1);
            newForm.Show();
            newForm.InitView();
            newForm.InitV3D();
        ...
        private void toolBarView_ButtonClick(object sender, System.Windows.Forms.ToolBarButtonClickEventArgs e)
        {
            ...
            switch (toolBarView.Buttons.IndexOf(e.Button))
            {
                ...
                case 15:
                    ...
                    break;
                case 16:
                    curForm.myOCCTProxy.ShowBottle(400, 300, 100);
                    break;
                case 17:
                    curForm.myOCCTProxy.showRect(200, 80, 500, 10, 5);
                    curForm.View.ZoomAllView();
                    break;
                default:
                    break;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            curForm.myOCCTProxy.ShowBottle(400, 300, 200);
        ...
        private void tBarNewWindow_Click(object sender, EventArgs e)
        {
        ...
        private void tBarAbout_Click(object sender, EventArgs e)
        {
            AboutDialog myDlg = new AboutDialog();
            myDlg.ShowDialog(this);
        }
        ...
        private void tBarDynamicRotation_Click(object sender, EventArgs e)
        {
            Form2 curForm = (Form2)this.ActiveMdiChild;
        ...
        private void tBarFitAll_Click(object sender, EventArgs e)
        {
